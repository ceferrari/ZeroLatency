...
```powershell
netsh int ip set global loopbacklargemtu=enabled && netsh int tcp set global autotuninglevel=normal && netsh int tcp set supplemental internet congestionprovider=cubic
```
